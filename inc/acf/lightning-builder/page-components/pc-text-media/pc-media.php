...
<div class="flex w-full <?php
                        ...
                        echo $full_width ? 'w-full !px-0 h-4/3' : '' ?> order-1 md:order-<?php echo $text_placement === '1' ? '2' : '1'; ?>">
    ...
    <?php if ($media_type === 'video') : ?>
        ...
        ?>
            <video class="object-cover <?php echo $full_width ? 'h-4/3' : 'aspect-video'; ?>" <?php echo $video_controls ? ' controls' : ' autoplay muted playsinline'; ?><?php echo $loop_video ? ' loop autoplay playsinline muted' : ''; ?>>

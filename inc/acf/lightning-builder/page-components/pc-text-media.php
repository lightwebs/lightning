...
?>
    ...
    <section <?php component_id($prefix); ?> class="pc-text-media relative section <?php echo $full_width ? 'md:flex items-center !py-0 ratio-4x3-md-height' : section_spacing(); ?> <?php echo s($prefix)['bg_color']; ?> <?php echo s($prefix)['text_color']; ?>">
        <?php

...
function case_post_type() {
    $labels = array(
        'name' => _x('Case', 'Post Type General Name', 'lightning'),
        'singular_name' => _x('Case', 'Post Type Singular Name', 'lightning'),
        'menu_name' => __('Case', 'lightning'),
        'name_admin_bar' => __('Case', 'lightning'),
        'archives' => __('Arkiv', 'lightning'),
        'attributes' => __('Attribut', 'lightning'),
        'parent_item_colon' => __('Föräldrarobjekt', 'lightning'),
        'all_items' => __('Alla Case', 'lightning'),
        'add_new_item' => __('Lägg till Case', 'lightning'),
        'add_new' => __(' Lägg till', 'lightning'),
        'new_item' => __('Nytt Case', 'lightning'),
        'edit_item' => __('Redigera Case', 'lightning'),
        'update_item' => __('Uppdatera Case', 'lightning'),
        'view_item' => __('Visa Case', 'lightning'),
        'view_items' => __('Visa Case', 'lightning'),
        'search_items' => __('Sök Case', 'lightning'),
        ...
        'insert_into_item' => __('Lägg till i Case', 'lightning'),
        'uploaded_to_this_item' => __('Uppladdat till det här objektet', 'lightning'),
        'items_list' => __('Case lista', 'lightning'),
        'items_list_navigation' => __('Case list-navigation', 'lightning'),
        'filter_items_list' => __('Filtrera Case lista', 'lightning'),
    );
    $args = array(
        'label' => __('Case', 'lightning'),
        'description' => __('Beskrivning av Case', 'lightning'),
        'labels' => $labels,
...
/**
 * Category taxonomy - Case 
 */

function case_category_taxonomy() {
    $labels = array(
...
add_action('init', 'case_category_taxonomy', 0);
